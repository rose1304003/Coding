...
class UserState:
    ...
    ADMIN_CREATE_HACKATHON_NAME_RU = "admin_create_hackathon_name_ru"
    ADMIN_CREATE_HACKATHON_NAME_EN = "admin_create_hackathon_name_en"
    ADMIN_CREATE_HACKATHON_DESC = "admin_create_hackathon_desc"
    ADMIN_CREATE_HACKATHON_DESC_RU = "admin_create_hackathon_desc_ru"
    ADMIN_CREATE_HACKATHON_DESC_EN = "admin_create_hackathon_desc_en"
    ADMIN_CREATE_HACKATHON_PRIZE = "admin_create_hackathon_prize"
    ADMIN_CREATE_HACKATHON_PRIZE_RU = "admin_create_hackathon_prize_ru"
    ADMIN_CREATE_HACKATHON_PRIZE_EN = "admin_create_hackathon_prize_en"
    ...
    ADMIN_CREATE_STAGE_NAME_RU = "admin_create_stage_name_ru"
    ADMIN_CREATE_STAGE_NAME_EN = "admin_create_stage_name_en"
    ADMIN_CREATE_STAGE_TASK = "admin_create_stage_task"
    ADMIN_CREATE_STAGE_TASK_RU = "admin_create_stage_task_ru"
    ADMIN_CREATE_STAGE_TASK_EN = "admin_create_stage_task_en"
